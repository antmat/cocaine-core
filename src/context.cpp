...
public:
        ...
        m_mapper(*m_config)
    {
        ...
        m_config->services().visit([&](const std::string& name, const config_t::component_t& service) mutable {
    ...
    terminate() {
        ...
        m_config->services().visit([&](const std::string& name, const config_t::component_t&){
            try {
